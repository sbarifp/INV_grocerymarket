...
class HomeNewExperienceFragment : Fragment(), HomeNewExperienceAdapter.ItemAdapterCallback {

//    private var productList : ArrayList<HomeVerticalModel> = ArrayList()
    private var newExperienceList : ArrayList<Data>? = ArrayList()
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        newExperienceList = arguments?.getParcelableArrayList("data")

//        initDataDummy()
        var adapter = HomeNewExperienceAdapter(newExperienceList!!, this)
