package com.ueesrg.grocerymarketkotlin.ui.home.popular
...
class HomePopularFragment : Fragment(), HomeNewExperienceAdapter.ItemAdapterCallback {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        //initDataDummy()
        var adapter = HomeNewExperienceAdapter(popularList!!, this)
