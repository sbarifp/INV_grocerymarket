...
//        productList.add(HomeModel("Cherry Healthy","",5f))
//        productList.add(HomeModel("Burger Tamayo","",4f))
//        productList.add(HomeModel("Bakhwan Cihuy","",4.5f))
//
//    }
    ...
    override fun onHomeSuccess(homeResponse: HomeResponse) {
        ...
        for (a in homeResponse.data.indices) {
            ...
            for (x in items.indices) {
                if (items[x].equals("new_product", true)) {
