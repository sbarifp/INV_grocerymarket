...
import com.ueesrg.grocerymarketkotlin.BuildConfig
import com.ueesrg.grocerymarketkotlin.GroceryMarket
import com.ueesrg.grocerymarketkotlin.utils.Helpers
...
class HttpClient {
    ...
    private fun buildRetrofitClient() {
        val token = GroceryMarket.getApp().getToken()
    ...
    fun buildRetrofitClient(token : String?){
        ...
        if (BuildConfig.DEBUG) {
            ...
            builder.addInterceptor(ChuckInterceptor(GroceryMarket.getApp()))
        }
