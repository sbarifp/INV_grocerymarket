<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link href="/dashboard/product" :active="request()->routeIs('dashboard/product')">
                        {{ __('Product') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="/dashboard/product" :active="request()->routeIs('dashboard/product')">
                {{ __('Product') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link href="/dashboard/transactions" :active="request()->routeIs('dashboard/transactions')">
                {{ __('Transactions') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link href="/dashboard/users" :active="request()->routeIs('dashboard/users')">
                {{ __('Users') }}
            </x-responsive-nav-link>
        </div>
